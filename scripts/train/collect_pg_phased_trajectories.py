...
Usage:
    python scripts/train/collect_pg_phased_trajectories.py --out-dir outputs/trajs_pg_phased
    python scripts/train/collect_pg_phased_trajectories.py --workers 8 --start-day 0 --end-day 295
"""
