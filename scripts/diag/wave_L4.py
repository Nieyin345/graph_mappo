...
OUT = REPO / "outputs"
LOGDIR = Path("/tmp/l4logs")

SEEDS = (42, 43, 44, 45, 46)
ARMS = [f"layers4_s{s}" for s in SEEDS]
...
def main() -> int:
    ...
    try:
        ...
        ctrl = arm = None
    EXPECTED = {"model.encoder.num_layers": 4}
    if ctrl and arm:
